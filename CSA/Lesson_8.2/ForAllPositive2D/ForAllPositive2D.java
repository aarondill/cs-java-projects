...
public class ForAllPositive2D {
  ...
  public static void main(String... args) throws FileNotFoundException {
    withScan("2DArrInt.dat", f -> {
      ...
      System.out.println("Check for all positive elements");
      if (Traversals.forAllPos(grid)) System.out.println("All elements are positive");
      else System.out.println("At least one element is not positive");
    });
  }
}
