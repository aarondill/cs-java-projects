...
public class Lab4A1_improved {
  private static String isAbleTo(int cAge, int minAge, String activity) {
    return String.format("At age %d a person is %s to %s.", cAge,
        cAge < minAge ? "old enough" : "not old enough", activity);
  }

  public static void main(String[] args) {
    ArrayList<Integer> ages = new ArrayList<>();
    InputStream file = Lab4A1_improved.class.getResourceAsStream("./lab4A1.in");
    if (file == null) {
      err.println(
    ...
    for (int age : ages) {
      out.println("****.**");
      // drive
      out.print(isAbleTo(age, 16, "drive"));
